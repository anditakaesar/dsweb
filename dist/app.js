...
var routers = _helper["default"].routers,
    ...
    funct = _helper["default"].funct,
    logger = _helper["default"].logger;
...
logger.info('App initializing...'); // middlewares
...
app.use((0, _cookieParser["default"])(env.COOKIES_SECRET));
logger.info('Db migrating...'); // migration

funct.migrateDatabase(); // static files
