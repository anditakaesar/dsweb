...
exports["default"] = exports.getPositionName = exports.getPosition = void 0;
...
var getPositionName = function getPositionName(entry, fieldNames) {
  var position = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
  var pos = position.find(function (p) {
    return p.positionCode == entry[fieldNames];
  });
...
function createBasePage(entry, res) {
  var templateHtml = _fs["default"].readFileSync(_path["default"].join(process.cwd(), 'views', 'doc_template.hbs'), 'utf-8');

  var template = _handlebars["default"].compile(templateHtml);

  var loadedEntry = (0, _entry["default"])(entry);
...
function _createPDF() {
  _createPDF = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(entry, res) {
    var html, base64html, response, buff, browser, page, pdf;
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            html = createBasePage(entry, res);

            if (!_helper.APP_OPTIONS.GENERATOR_URL_ACTIVE) {
              _context.next = 10;
              break;
            }
            ...
            _context.next = 5;
            return _axios["default"].post(_helper.APP_OPTIONS.GENERATOR_URL, {
              html: base64html
            });
